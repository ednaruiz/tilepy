import os
from ..include.PointingTools import (
...
from ..include.Observatories import (
    CTANorthObservatory,
    HESSObservatory,
)
from ..include.PointingPlotting import (
    LoadPointingsGAL,
...
def Time_DarkTime_GreyTime(
    ...
    hp.graticule()
    plt.savefig("VisibilityTime_DarkTime_GreyTime_Overview" + observatory.Name + ".png")
