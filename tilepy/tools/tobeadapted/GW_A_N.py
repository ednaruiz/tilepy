...
# load the GW map
# url = 'https://gracedb.ligo.org/api/superevents/S200224ca/files/LALInference.fits.gz,1'
...
# ax_inset.coords[0].set_axislabel('Right Ascension (J2000)')
# ax_inset.coords[1].set_axislabel('Declination (J2000)')
