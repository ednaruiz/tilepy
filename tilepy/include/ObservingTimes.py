...
def ObtainObservingTimes(totaltime,delayAlert,run,id,observatory,dirName,zenith):
  ...
  if observatory.name=="North":
    ...
    if int(zenith)==20:
        ...
        sensifilenorthz20 = dirName + grbSensPath + "grbsens-5.0sigma_t1s-t16384s_irf-North_z20_0.5h.txt"  # "sensitivity-5sigma_irf-North_z20_0.5.txt"
        ...
        sensifilenorthz40 = dirName + grbSensPath + "grbsens-5.0sigma_t1s-t16384s_irf-North_z40_0.5h.txt"
        ...
        sensifilenorthz60 = dirName + grbSensPath +"grbsens-5.0sigma_t1s-t16384s_irf-North_z60_0.5h.txt"
    ...
    if int(zenith)==20:
        ...
        sensifilesouthz20 = dirName + grbSensPath + "grbsens-5.0sigma_t1s-t16384s_irf-South_z20_0.5h.txt"
        ...
        sensifilesouthz40 = dirName+ grbSensPath + "grbsens-5.0sigma_t1s-t16384s_irf-South_z40_0.5h.txt"
        ...
        ###############
        # sensitivity CTA South, zenit=40 deg
        sensifilesouthz60 = dirName + grbSensPath + "grbsens-5.0sigma_t1s-t16384s_irf-South_z60_0.5h.txt"
